...
class TestKillSwitchPersistence:
    ...
    def test_kill_switch_survives_restart(self, tmp_path):
        ...
        risk_manager = RiskManager(
            ...
            max_position_pct=1.0, max_risk_per_trade_pct=0.01,
            kill_switch_file=str(tmp_path / "risk_kill_switch.json"),
        )
        risk_manager.reset_daily(100000)
        ...
        risk_manager2 = RiskManager(
            ...
            max_monthly_loss_pct=0.50, max_drawdown_pct=0.15,
            max_position_pct=1.0, max_risk_per_trade_pct=0.01,
            kill_switch_file=risk_manager.KILL_SWITCH_FILE,
        )
        risk_manager2.reset_daily(100000)
        risk_manager2.peak_equity = 100000
        risk_manager2.current_equity = 100000
        ...
        can_open, reason = risk_manager2.can_open_position('XAUUSD', 10000, 100000)
    ...
    def test_manual_reset_clears_halt(self, tmp_path):
        ...
        # Can open position
        can_open, reason = risk_manager.can_open_position('XAUUSD', 10000, 100000)
