#!/usr/bin/env python3
"""
Simple integration test using mocked MT5.
"""
import sys
import os
import tempfile
...
def main():
    ...
    mock_mt5_2 = Mock()
    mock_mt5_2.ORDER_TYPE_BUY = 0
    mock_mt5_2.ORDER_TYPE_SELL = 1
    mock_mt5_2.TRADE_ACTION_DEAL = 1
    mock_mt5_2.TRADE_RETCODE_DONE = 10009
    mock_mt5_2.ORDER_TIME_GTC = 0
    mock_mt5_2.ORDER_FILLING_FOK = 0

    mock_account_2 = Mock()
    mock_account_2.login = 476944496
    mock_account_2.trade_mode = 0
    mock_account_2.balance = 100000.0
    mock_account_2.equity = 100000.0
    mock_account_2.currency = 'USD'
    mock_account_2.leverage = 2000
    mock_mt5_2.account_info.return_value = mock_account_2

    mock_symbol_2 = Mock()
    mock_symbol_2.name = 'XAUUSDm'
    mock_symbol_2.trade_contract_size = 100.0
    mock_symbol_2.volume_min = 0.01
    mock_symbol_2.volume_max = 200.0
    mock_symbol_2.volume_step = 0.01
    mock_symbol_2.digits = 3
    mock_symbol_2.point = 0.001
    mock_symbol_2.spread = 260
    mock_symbol_2.bid = 4414.36
    mock_symbol_2.ask = 4414.62
    mock_symbol_2.visible = True
    mock_symbol_2.trade_tick_size = 0.001
    mock_symbol_2.trade_tick_value = 1.0
    mock_symbol_2.swap_long = -1.5
    mock_symbol_2.swap_short = -0.5
    mock_symbol_2.margin_initial = 1000.0
    mock_symbol_2.margin_maintenance = 500.0
    mock_symbol_2.session_deals = 0
    mock_symbol_2.session_buy_orders = 0
    mock_symbol_2.session_sell_orders = 0
    mock_symbol_2.time = 1704067200

    mock_mt5_2.symbol_info.return_value = mock_symbol_2
    mock_mt5_2.symbol_info_tick.return_value = Mock(bid=4414.36, ask=4414.62)
    mock_mt5_2.order_send.return_value = Mock(
        retcode=10009,
        ticket=123456789,
        order=987654321,
        volume=0.5,
